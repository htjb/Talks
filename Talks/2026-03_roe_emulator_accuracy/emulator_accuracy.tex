...
\begin{frame}{Sky-averaged 21-cm cosmology with ARES and globalemu}
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=0.98\textwidth]{figs/posterior_ares_fiducial_model_noise_250_ARES_True_FIXED_NOISE_True.png}
            \\[-0.3em]
...
\begin{frame}{KL divergence bound vs observed accuracy}
        \begin{itemize}
            ...
            \item Dotted lines mark our four noise levels;
                    dashed lines are constant-RMSE contours for the trained network
        \end{itemize}
        \hfill
        {\centering
    ...
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            \begin{itemize}
                ...
                \item Plan to demonstrate applications to the 21-cm \textbf{power spectrum emulators} and beyond with \textsc{astroemu}
            \end{itemize}
        \end{column}
        \hfill
